...
/**
 * Created by Jaap Heijligers on 3/25/15.
 */
public class JsInterpreter {
    ...
    public static void main(String[] args) throws ParseException {
        String sig = new JsInterpreter().execute("function main(a){a=a.split(\"\");hG.Iw(a,19);hG.Iw(a,35);hG.sJ(a,23);hG.js(a,2);hG.sJ(a,44);hG.js(a,1);hG.Iw(a,64);hG.js(a,2);hG.Iw(a,53);return a.join(\"\")};var hG={sJ:function(a){a.reverse()},Iw:function(a,b){var c=a[0];a[0]=a[b%a.length];a[b]=c},js:function(a,b){a.splice(0,b)}};", "8B61628A11ADDC7B14A052AD6C7C4246C62BFB348D3.A40D3DFB54E8B230CAB4C1A39FBEB2B978E5200F0F");
